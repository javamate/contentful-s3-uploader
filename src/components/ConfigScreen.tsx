    ...
    return (
      <Workbench className={css({ margin: '80px' })}>
        <Form>
          ...
          <Paragraph>There's nothing to configure right here. You'll find the S3 File Uploader App available in the Appearance tab on JSON Object fields.</Paragraph>
        </Form>
      </Workbench>
    );
  }
